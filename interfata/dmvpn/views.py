...
def ipsec_esp(request):
    ...
    channel.send('shut\n')
    time.sleep(1)
    channel.send('tunnel protection ipsec profile IPSEC_PROFILE1\n')
    time.sleep(1)
    channel.send('no shut\n')
    time.sleep(1)
...
def ipsec_ah(request):
    ...
    channel.send('shut\n')
    time.sleep(1)
    channel.send('tunnel protection ipsec profile IPSEC_PROFILE\n')
    time.sleep(1)
    channel.send('no shut\n')
    time.sleep(1)
